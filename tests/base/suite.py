...
class BasePaginationTestSuite:
    ...
    def __init_subclass__(cls, **kwargs):
        ...
        suites = [pytest.param(*values, id=id_) for *values, id_ in cls.generate_suites()]
        ...
        cursor_suites = [pytest.param(*values, id=id_) for *values, id_ in cls.generate_cursor_suites()]
    ...
    def generate_cursor_suites(cls) -> Iterable[SuiteDecl]:
        ...
        if "relationship" in cls.case_types:
            yield CursorParams(size=22), "cursor", "relationship", "cursor-relationship"
